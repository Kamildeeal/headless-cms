...
const LinkHeader = ({ children, href }: LinkHeaderProps) => {
  ...
  return (
    <Link
      href={href}
      className="group font-roboto text-sm text-gray-200 relative inline-block overflow-hidden rounded px-2 py-1 hover:border-sky-600 focus:outline-none active:text-sky-600"
    >
